 ...
 * Bei Aufruf von Yield:
 - Auswahl des nächsten Prozesses 	-- 	Hier haben wir noch ein Problem.  mit den alten "interval"-Werten ist der
																				letzte Vergleich 500000 >= 0 (und 0 auch nur weil mit einem Wert außerhalb der Arrays verglichen wird)
...
/******************************************************************
* Funktionsinterna hab ich nur geändert um zu prüfen ob lokale Werte bei switch erhalten werden
*
******************************************************************/
void led1(void) {
	while (1) {
